...
public class ApiStackTest extends TFTestCase {
	...
	public void testPushInterface(){
	    assertNull(ApiStack.queryInterface(ApiStackTest.class));
	    assertNull(ApiStack.queryInterface(TFTestCase.class));
	    ApiStack.pushInterface(TFTestCase.class, this);
	    ApiStack.pushInterface(ApiStackTest.class, this);
	    assertEquals(this, ApiStack.getInterface(ApiStackTest.class));
	    assertEquals(this, ApiStack.getInterface(TFTestCase.class));
	    ApiStack.popInterface(1);
        assertEquals(null, ApiStack.queryInterface(ApiStackTest.class));
        assertEquals(this, ApiStack.getInterface(TFTestCase.class));
        ApiStack.popInterface(1);
        assertEquals(null, ApiStack.queryInterface(ApiStackTest.class));
        assertEquals(null, ApiStack.queryInterface(TFTestCase.class));
	}
